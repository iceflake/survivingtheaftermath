...
namespace UnityEditor
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent windText = EditorGUIUtility.TrTextContent("Wind (vertex r)", "Wind strength");
            public static GUIContent windYText = EditorGUIUtility.TrTextContent("Vertical Wind", "Vertical wind amount");

            public static GUIContent snowMultiplierText = EditorGUIUtility.TrTextContent("Snow Multiplier", "Multiplier for the visual snow");
        ...
        MaterialProperty windY = null;
        MaterialProperty snowMultiplier = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            wind = FindProperty("_Wind", props);
            windY = FindProperty("_YWind", props);

            snowMultiplier = FindProperty("_SnowMultiplier", props);
        }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ShaderProperty(wind, Styles.windText);
                m_MaterialEditor.ShaderProperty(windY, Styles.windYText);
                
                EditorGUILayout.Space();
                m_MaterialEditor.ShaderProperty(snowMultiplier, Styles.snowMultiplierText);
